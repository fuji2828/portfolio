...
export default function Projects() {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: "An end-to-end Python pipeline that converts MP3/WAV audio into sheet music, from stem separation to PDF export. Integrated ML-based source separation (Demucs) with audio analysis (librosa) to transcribe music without original stems. Implemented beat-aligned rhythm quantization and automated MIDI, MusicXML, and PDF generation via MuseScore CLI.",
